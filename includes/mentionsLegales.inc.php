...
<section id="section-principale">
  <div class="wrap">
    ...
    <ul>
      <li>Le site de Mélanie Leblanc</li>
      <li>par Mélanie Leblanc</li>
      <li>00 boulevard Perdu</li>
      <li>00000 Nulpart</li>
      <li>France</li>
      <li>https://www.le-site-de-melanie-leblanc.fr</li>
      <li>Tél. : + 33 (0)0 00 00 00 00</li>
    </ul>
    ...
    <ul>
      ...
      <li>France</li>
      <li>Tél. : + 33 (0)0 00 00 00 00</li>
      <li>http://www.le-site-de-melanie-leblanc.fr</li>
    </ul>
    ...
    <ul>
      ...
      <li>Tout contenu téléchargé se fait aux risques et périls de l'utilisateur et sous sa seule responsabilité. En conséquence, Natural net ne saurait être tenu responsable d'un quelconque dommage subi par l'ordinateur de l'utilisateur ou d'une quelconque perte de données consécutives au téléchargement.</li>
      <li>Les photos sont non contractuelles.</li>
      <li>Les liens hypertextes mis en place dans le cadre du présent site internet en direction d'autres ressources présentes sur le réseau Internet ne sauraient engager la responsabilité de Natural net.</li>
    </ul>
    </div>
    ...
    <ul>
      ...
      <li>Natural net est identiquement propriétaire des "droits des producteurs de bases de données" visés au Livre III, Titre IV, du Code de la Propriété Intellectuelle (loi n° 98-536 du 1er juillet 1998) relative aux droits d'auteur et aux bases de données.</li>
      ...
      <li>Pour toute demande d'autorisation ou d'information, veuillez nous contacter par email : contact@natural-net.fr. Des conditions spécifiques sont prévues pour la presse. </li>
      <li>Par ailleurs, la mise en forme de ce site a nécessité le recours à des sources externes dont nous avons acquis les droits ou dont les droits d'utilisation sont ouverts : Seosight, Designed by themefire Developed by Crumina​. Les illustrations ont été acquises sur Adobe Stock.</li>
    </ul>
    </div>

    <h3>Conditionss de service</h3>
    ...
    <div id="test">
    <ul>
      <li>Les sites internet de Natural net peuvent offrir des liens vers d’autres sites internet ou d’autres ressources disponibles sur Internet.</li>
      <li>Natural net ne dispose d'aucun moyen pour contrôler les sites en connexion avec ses sites internet. Natural net ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit. Elle ne peut être tenue pour responsable de tout dommage, de quelque nature que ce soit, résultant du contenu de ces sites ou sources externes, et notamment des informations, produits ou services qu’ils proposent, ou de tout usage qui peut être fait de ces éléments. Les risques liés à cette utilisation incombent pleinement à l'internaute, qui doit se conformer à leurs conditions d'utilisation.</li>
      <li>Les utilisateurs, les abonnés et les visiteurs des sites internet de Natural net ne peuvent mettre en place un hyperlien en direction de ce site sans l'autorisation expresse et préalable de Natural net.</li>
      <li>Dans l'hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en direction d’un des sites internet de Natural net, il lui appartiendra d'adresser un email accessible sur le site afin de formuler sa demande de mise en place d'un hyperlien. Natural net se réserve le droit d’accepter ou de refuser un hyperlien sans avoir à en justifier sa décision.</li>
    </ul>
    </div>
    ...
    <p>Natural net est à votre disposition pour tous vos commentaires ou suggestions. Vous pouvez nous écrire en français par courrier électronique à : <a href="mailto:contact@lesitedemelanieleblanc.fr.?subject=feedback">contact@lesitedemelanieleblanc.fr</a></p>
